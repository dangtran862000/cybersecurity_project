    ...
    <body>
        ...
        <div>
            ...
            while ($row_quiz = mysqli_fetch_assoc($result_quiz)){
                echo '<p>' . $row_quiz['question'] . '</p>';
                echo '<button class="loginbutton" type="submit" name="submit">' . $row_quiz['answer1'] . '</button><br>';
                echo '<button class="loginbutton" type="submit" name="submit">' . $row_quiz['answer2'] . '</button>';
            }
            ?>
        </div>
